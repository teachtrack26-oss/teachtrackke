...
def validate_and_import_social_studies():
    json_file_path = r"c:\Users\MKT\desktop\teachtrack\G4\grade-4-social-studies.json"
...
if __name__ == "__main__":
    validate_and_import_social_studies()
