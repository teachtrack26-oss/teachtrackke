...
def validate_and_import_math():
    json_file_path = r"c:\Users\MKT\desktop\teachtrack\G4\grade-4-mathematics.json"
    ...
    try:
        # Get the template
        # We know the ID is 71 from the check script
        template_id = 71
