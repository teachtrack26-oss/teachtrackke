...
def validate_and_import_cre():
    json_file_path = r"c:\Users\MKT\desktop\teachtrack\G4\grade-4-cre.json"
    ...
    try:
        # Get the template
        # ID 72 is Religious Education (CRE/IRE/HRE)
        template_id = 72
