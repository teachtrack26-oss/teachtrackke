...
# All curriculum related files
curriculum_dir = r'c:\Users\MKT\Desktop\teachtrack\frontend\app\curriculum'
            ...
            try:
                ...
                if content != original:
                    with open(path, 'w', encoding='utf-8') as f:
                        f.write(content)
                    updated_files.append(os.path.relpath(path, curriculum_dir))
...
print("\nCurriculum pages updated with Saatosa Dark Theme!")
