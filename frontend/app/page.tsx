      ...
      <header className="relative h-[700px] md:h-[800px] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 h-full flex flex-col justify-center items-center text-center">
          ...
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-white/95 drop-shadow-lg leading-relaxed">
            Track curriculum, manage timetables, create AI-powered lesson plans,
            and generate professional reports. All in one place.
          </p>
          ...
          {!isLoggedIn && (
            <p className="mt-6 text-white/90 drop-shadow">
              🎁 No credit card required • Free for 6 subjects • Cancel anytime
            </p>
          )}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Create, manage, and track your weekly timetable. Drag-and-drop rescheduling with automatic conflict detection.",
              ...
              },
              {
                ...
                description:
                  "Create lesson plans, schemes of work, and records of work. Export to PDF with professional templates.",
              ...
              },
              {
                ...
                description:
                  "Real-time dashboards with curriculum progress, attendance tracking, teaching insights, and performance metrics.",
              ...
              >
                ...
                {/* Decorative element */}
                <div
                  className={`absolute -bottom-8 -right-8 w-32 h-32 bg-gradient-to-br ${feature.color} opacity-0 group-hover:opacity-10 rounded-full transition-opacity duration-500`}
                />
              </div>
            ))}
          </div>
            ...
            {[
              {
                ...
                content:
                  "TeachTrack has transformed how I plan my lessons. The AI assistance saves me hours every week, and my students love the organized approach!",
                rating: 5,
              },
              {
                name: "James Omondi",
                ...
                content:
                  "Managing 8 different subjects was overwhelming. Now everything is in one place, and the curriculum tracking keeps me on schedule perfectly.",
                rating: 5,
              },
              {
                name: "Faith Mutua",
                ...
                content:
                  "The analytics dashboard gives me instant insights into teaching progress across all grades. It's a game-changer for school administration!",
                rating: 5,
              },
            ...
            {[
              {
                ...
                description:
                  "Create your timetable, select CBC curricula for your subjects (Grades 1-10), and configure your teaching schedule with time slots and class sections.",
              ...
              },
              {
                ...
                description:
                  "View today's lessons on your dashboard, mark attendance, track curriculum progress, and access teaching resources. Drag-and-drop to reschedule lessons instantly.",
              ...
              },
              {
                ...
                description:
                  "Generate lesson plans with AI assistance, create schemes of work, maintain records of work, and export everything to professional PDF formats.",
              ...
              },
              {
                ...
                description:
                  "Track curriculum completion, attendance rates, teaching insights, and performance metrics. View upcoming deadlines and resource center all in one place.",
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl mb-10 text-white/95 drop-shadow-lg max-w-3xl mx-auto leading-relaxed">
            Join hundreds of Kenyan teachers using TeachTrack for curriculum
            management, timetabling, lesson planning, and professional
            documentation
          </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                The complete teaching management platform built specifically for
                Kenyan CBC educators.
              </p>
            </div>
            <div>
          ...
          <div className="pt-8 border-t border-gray-800 text-center">
            <p className="text-gray-400">
              &copy; 2025 TeachTrack CBC. Built with ❤️ for Kenyan Teachers.
            </p>
          </div>
        </div>
      </footer>
